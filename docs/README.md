...
Compiled from archived fan sites, guild pages, personal pages, and the official website captured from the Internet Archive (Wayback Machine). This documentation unifies information from ~13,000 files across 26+ different websites.
...
- **[Guilds & Community](General/guilds-and-community.md)** - Known guilds, fan site ecosystem, community culture, events, international community, historical significance.
- **[Developer Q&A (2002)](General/developer-qa-2002.md)** - Complete summary of the April 10, 2002 developer/player Q&A session with key announcements, class discussions, and notable quotes.
- **[Glossary & Reference](General/glossary-and-reference.md)** - Common abbreviations (50+), weapon skill level names (0-30), weapon categories with range types, race stat caps, equipment slots, and key damage/cost formulas.

### Class Guides

- **[Healer](Classes/healer.md)** - Complete discipline list (23 skills), gearing, skilling strategy, maxxing, Cobrahn transition, party role.
- **[Mentalist](Classes/mentalist.md)** - Complete spell list (30+ spells with EP costs, stress factors, and detailed notes), skill level titles, gearing, skilling strategy, enchanting.
- **[Fighter](Classes/fighter.md)** - Primary melee combat class, weapon specializations, Fighter/Mentalist multi-class.
- **[Barbarian](Classes/barbarian.md)** - Highest HP cap, Zerk mechanics, Autobalm, known issues from 2002 Q&A.
- **[Paladin](Classes/paladin.md)** - Holy warrior, dedication requirements, FOCUS abilities, special gear.
- **[Martial Artist](Classes/martial-artist.md)** - Unarmed combat specialist, complete ability progression (skill 6-29), known issues.
- **[Thief](Classes/thief.md)** - Stealth class, discipline list, progression, weapon choices, gear, PK mechanics.
...
| wolfguild.com | Wolf Guild mirrors (17 guild sites) | 5,000+ |
